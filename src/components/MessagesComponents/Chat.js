  ...
  const dataMSG = [
    {
      ...
      mensagem: [
        ...
        },
        {
          ...
          tipo: "TEXTO",
          mensagem:
            "Podemos marcar uma reunião para amanha as 19h via meet, sobre como o PowerPoint deve ser",
          extensão: "",
          url: "",
        },
      ],
    ...
    <View style={styles.container}>
      <View style={styles.headerChat}>
        ...
        >
          ...
          <Image style={styles.selfPhoto} alt="self" source={{ uri: photo }} />
        </TouchableOpacity>
        <Text
          style={{
            fontSize: 24,
      ...
      <View
        style={{
          width: "100%",
          height:
            menssagenSendDescHeight + 20 > 120
              ? 120
              : menssagenSendDescHeight + 30,
      ...
      >
        <TextInput
          style={{
            height:
              menssagenSendDescHeight > 100 ? 100 : menssagenSendDescHeight,
            borderWidth: 0,
            width: "70%",
            paddingHorizontal: 8,
            color: colors.gray,
          ...
          onContentSizeChange={(e) =>
            setMenssagenSendDescHeight(e.nativeEvent.contentSize.height + 24)
          }
        />
        <View
          style={{
