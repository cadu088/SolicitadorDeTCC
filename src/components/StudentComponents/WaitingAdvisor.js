    ...
    <View style={{ width: "100%", height: "100%" }}>
      <SafeAreaView>
        <ScrollView vertical={true}>
          {data.map((item) => (
            <View key={item.iD_SOLICITACAO} style={styles.cardSolicited}>
              <View style={styles.headerSolicited}>
                {/* <Image
								...
								/> */}
                <Text style={styles.titleAdvisor}>
                  Solicitado para {item.professor.nome}
                </Text>
              </View>
              <View style={styles.bodySolicited}>
                <Text style={styles.titleTask}>{item.nome}</Text>
              ...
              <View style={styles.baseboard}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <Image
                    ...
                    alt="self"
                    source={{ uri: item.professor.img }}
                  />
                  <Text style={styles.nameAdvisor}>{item.professor.nome}</Text>
                </View>
